...
# 横坐标范围从0到13，每1为一刻度
x_min, x_max = 0, 18
x_ticks = np.arange(0, 18.5, 1)  # 每1为一刻度

# 纵坐标范围从0到1
y_min, y_max = 0, 1

# 数据
PCR10 = [6.12, 3.33, 7.51]
PCR30 = [7.68, 4.32, 9.75]
PCR60 = [12.85, 7.8, 17.61]
...
# 显示图例
plt.legend(all_handles, all_labels, loc='center', bbox_to_anchor=(0.846, 0.5), bbox_transform=plt.gca().transAxes)

# 显示图形
plt.tight_layout()
plt.savefig('a=2 R=1.25.pdf', format='pdf')
plt.show()
